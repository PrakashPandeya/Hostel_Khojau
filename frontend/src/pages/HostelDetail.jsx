...
const HostelDetails = () => {
  ...
  // Calculate derived stats based on reviews
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-wrap gap-4 mt-4">
            ...
            {hostel.ownername && (
              <div className="bg-gray-100 px-4 py-2 rounded-lg">
                <span className="font-medium">Owner:</span> {hostel.ownername}
              </div>
            )}
          </div>
        </div>
        ...
        <div className="flex flex-wrap gap-4">
          <button className="bg-red-500 hover:bg-red-600 text-white px-6 py-3 rounded-lg transition duration-200">
            Book Now
          </button>
          {hostel.contact?.phone && (
            <a 
